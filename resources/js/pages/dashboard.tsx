            ...
            <div className="flex flex-col gap-4 p-4">
                ...
                <div className="flex flex-wrap items-end gap-4 rounded-lg border p-4 text-sm">
                    ...
                    <label className="flex flex-col gap-1">
                        ...
                        <Select
                            value={selectedUserId === null ? SELECT_ALL_VALUE : String(selectedUserId)}
                                    ...
                                    <tr key={row.id} className="border-b align-top last:border-0">
                                        ...
                                        <td className="p-3">
                                            ...
                                            <div
                                                ...
                                                title="Idle real = kapasitas dikurangi realisasi aktual (efisiensi, bukan untuk keputusan assign)"
                                            >
