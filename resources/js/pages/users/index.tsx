...
//               F-170: `users`/`roles` SEKARANG bisa null (UserController::index()
//               kirim null kalau permission user.manage/role.manage tidak dipegang)
        ...
        <AppLayout breadcrumbs={breadcrumbs}>
            ...
            <div className="flex flex-col gap-4 p-4">
                ...
                <div className="flex flex-wrap items-center justify-between gap-2">
                    <div>
                        ...
                        <p className="text-muted-foreground text-sm">
                            {users !== null && `${users.length} pengguna`}
                            {users !== null && roles !== null && ' · '}
                            {roles !== null && `${roles.length} peran`}
                        </p>
                    </div>
                ...
                {/* Permintaan Boss: 2 kolom agar data pengguna & peran langsung
                    ...
                    F-170: grid jatuh ke 1 kolom kalau salah satu sisi null (role
                    yang cuma pegang salah satu permission user.manage/role.manage). */}
                <div className={`grid grid-cols-1 gap-4 ${users !== null && roles !== null ? 'lg:grid-cols-[3fr_2fr]' : ''}`}>
                    {users !== null && (
                        <Card>
                            <CardHeader>
                                            ...
                                            <tr key={user.id} className="border-b last:border-0">
                                                ...
                                                <td className="p-3">
                                                    <div className="flex flex-wrap items-center gap-3">
                                                        ...
                                                        {/* Permintaan Boss (2026-08-27): toggle nonaktif/aktif pakai
                                                            shadcn Switch, gantikan tombol teks Nonaktifkan/Aktifkan --
                                                            toggleActive() TIDAK berubah (masih confirmAction + PATCH
                                                            sama), cuma kontrol pemicunya yang beda. */}
                                                        <Switch
                ...
                <div className="bg-muted/30 text-muted-foreground flex items-start gap-2 rounded-lg border p-4 text-sm">
                    ...
                    <p>
                        <span className="text-foreground font-medium">Peran dinamis:</span> peran & izin tersimpan sebagai data, bukan kode. Menambah
                        peran baru cukup satu klik — tidak perlu deploy ulang. Peran sistem (admin/member) tidak bisa dihapus.
                    </p>
                </div>
            </div>
        </AppLayout>
